...
from neuromaps import NeuroMapAdaptiveScale
...
checkpoint_dir = "experiments/adaptive_nm/checkpoints/adaptive"
...
if checkpoint_files:
    ...
    if checkpoint_path.exists():
        ...
        model = NeuroMapAdaptiveScale.load(str(checkpoint_path))
...
model_path = "experiments/adaptive_nm/checkpoints/adaptive/model.ckpt"
