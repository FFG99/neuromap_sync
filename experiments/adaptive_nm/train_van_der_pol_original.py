...
checkpoint_dir = "experiments/adaptive_nm/checkpoints/original"
...
model.fit(X, y, epochs=1000, lr=5e-4, batch_size=512, val_split=0.2, 
          ...
          history_path="experiments/adaptive_nm/checkpoints/original/history.json")

model_path = "experiments/adaptive_nm/checkpoints/original/model.ckpt"
