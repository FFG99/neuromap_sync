...
checkpoint_dir = "experiments/normalization_chua/checkpoints/original"
...
model.fit(X, y, epochs=1000, lr=5e-4, batch_size=512, val_split=0.2, 
          ...
          history_path="experiments/normalization_chua/checkpoints/original/history.json")

model_path = "experiments/normalization_chua/checkpoints/original/model.ckpt"
