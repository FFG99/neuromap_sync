...
checkpoint_dir = "experiments/normalization_2layers/checkpoints/fixed"
...
if checkpoint_files:
    ...
    model = NeuroMapTargetNormalized(n_var=2, n_param=2, hidden_size=256, num_hidden_layers=2, dt=0.01)
else:
...
model.fit(X, y, epochs=1000, lr=5e-4, batch_size=512, val_split=0.2,
          ...
          history_path="experiments/normalization_2layers/checkpoints/fixed/history.json")

model_path = "experiments/normalization_2layers/checkpoints/fixed/model.ckpt"
