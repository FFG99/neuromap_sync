...
checkpoint_dir = "experiments/normalization_chua2/checkpoints/fixed"
...
model.fit(X, y,
          ...
          history_path="experiments/normalization_chua2/checkpoints/fixed/history.json")

model_path = "experiments/normalization_chua2/checkpoints/fixed/model.ckpt"
