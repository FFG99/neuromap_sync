"""
Новый эксперимент manuscript_1:
обучение NeuroMapManuscriptSubnets (подсеть на каждую переменную).

Чекпоинты: experiments/manuscript_1/checkpoints_subnets/
"""
import numpy as np
...
CHECKPOINT_DIR = Path("experiments/manuscript_1/checkpoints_subnets")
...
if checkpoint_files:
    ...
    print("Создаём новую Subnets-модель…")
